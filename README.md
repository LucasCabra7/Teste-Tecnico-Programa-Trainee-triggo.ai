...
<h1> TESTE TÉNICO - TRAINEE TRIGGO</h1>
<div align="center">
...
<h2> 📋 Teste Técnico – Programa Trainee triggo.ai: </h2>

Teste Técnico – Programa Trainee triggo.ai
Este repositório contém a resolução do Teste Técnico proposto no processo seletivo para o Programa Trainee da triggo.ai. O desafio tem como objetivo colocar à prova minhas habilidades técnicas em Python, SQL, Banco de Dados e lógica de programação, em um cenário que simula desafios reais enfrentados na área de Dados.

A tarefa principal consiste em analisar um conjunto de dados históricos de vendas com o objetivo de extrair insights valiosos que possam embasar decisões estratégicas de negócio. Para isso, foi utilizado o dataset "Brazilian E-commerce Public Dataset by Olist", disponível no Kaggle.

Habilidades e ferramentas utilizadas:
Python com bibliotecas como pandas, numpy, matplotlib e seaborn para análise e visualização de dados;

SQL (via SQLite e também com pandas) para consultas e manipulação dos dados;

Criação de visualizações e dashboards interativos com plotly e outras ferramentas gráficas;

Boas práticas de código, com foco em clareza, modularidade e reprodutibilidade.

Explore o repositório para ver o processo de análise, os insights obtidos e as visualizações construídas a partir dos dados.
